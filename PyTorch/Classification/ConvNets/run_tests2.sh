...
python ./multiproc.py --nproc_per_node 8 ./main.py --arch efficientnet-b0 --label-smoothing 0.1 --data-backend dali-cpu-gpu-aa --augmentation autoaugment  --batch-size 64 --epochs 4 --workspace /klecki/raport2/ --raport-file raport-aa-cpu-gpu.json /imgnet

python ./multiproc.py --nproc_per_node 8 ./main.py --arch efficientnet-b0 --label-smoothing 0.1 --data-backend dali-cpu-gpu-aa-2 --augmentation autoaugment  --batch-size 64 --epochs 4 --workspace /klecki/raport2/ --raport-file raport-aa-cpu-gpu-2.json /imgnet
